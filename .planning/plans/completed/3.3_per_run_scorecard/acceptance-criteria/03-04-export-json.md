...
This acceptance criterion covers the `atcr leaderboard --export` flag entry point and filter pass-through. The detailed public submission schema, anonymization rules, `--output` handling, and determinism requirements are owned by [04-01](04-01-export-command-public-schema.md), [04-02](04-02-anonymization-pii-stripping.md), [04-03](04-03-metric-preservation-metadata.md), and [04-04](04-04-determinism-filtering-errors.md).

## Acceptance Criteria Statement
When `--export` is set, `atcr leaderboard` emits a versioned, anonymized JSON envelope of the aggregated leaderboard rows instead of rendering a table.
