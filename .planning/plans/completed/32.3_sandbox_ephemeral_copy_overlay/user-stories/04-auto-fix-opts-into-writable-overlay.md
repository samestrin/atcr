...
| **Priority** | High |
| **Effort Estimate** | S |
| **Dependencies** | Stories 1, 2, 3 (Opt-In Writable Configuration Surface; Conditional Writable /work Mount; Ephemeral-Copy Setup Injection) — requires `RunSpec.Writable` to exist and `dockerRunArgs` to correctly act on it |
