...
- **Then** JSON record contains: `schema_version`, `run_id`, `timestamp`, `reviewer`, `model`, `role`, `findings_raised`, `findings_corroborated`, `findings_solo`, `corroboration_rate`, `cost_usd`, `tokens_in`, `tokens_out`, `latency_ms`
