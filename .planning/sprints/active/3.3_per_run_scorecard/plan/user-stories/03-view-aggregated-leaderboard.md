...
| AC | Title | AC File |
|----|-------|----------|
| 03-01 | Leaderboard Ranked Table Display | [03-01](../acceptance-criteria/03-01-leaderboard-table.md) |
| 03-02 | Time Range Filter (--since) | [03-02](../acceptance-criteria/03-02-since-filter.md) |
| 03-03 | Model and Persona Filters | [03-03](../acceptance-criteria/03-03-model-persona-filters.md) |
| 03-05 | Graceful Empty and Missing Data Handling | [03-05](../acceptance-criteria/03-05-graceful-empty-handling.md) |

The `--export` flag entry point is owned by [Story 4: Export Public Leaderboard Submission](04-export-public-leaderboard.md); Story 3's responsibility is to pass the active filters to the export path and to render the table view when `--export` is absent.
...
7. `--export` outputs the aggregated data as versioned JSON suitable for Epic 10.0 public leaderboard submission (anonymized, no provider keys or repo content). → **[04: Export Public Leaderboard Submission](04-export-public-leaderboard.md)** (Story 3 passes filters; Story 4 owns schema and anonymization).
