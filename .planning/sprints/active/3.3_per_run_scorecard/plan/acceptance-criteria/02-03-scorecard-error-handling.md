...
The `atcr scorecard` command handles missing records, corrupted JSONL lines, invalid arguments, and permission errors with appropriate exit codes and clear error messages.
