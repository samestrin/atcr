...
When `--no-scorecard` is set, the scorecard emission path returns before any file I/O, resulting in zero records written and no scorecard-related output for that reconcile run.
