...
| 2 | [ ] | LOW | internal/astgroup/parsers/src/braceparser/main.go:41 | Potential memory leak in pins map | Implement a mechanism to limit the growth of the pins map or ensure all allocated memory is freed by the host | resource-management | 30 | code-review | otto | MEDIUM |
...
| 2 | [ ] | MEDIUM | internal/astgroup/parsers/src/braceparser/parse_core.go:167 | No bounds check before unsafe pointer cast | Add length check before unsafe.Pointer(&b[0]) | security | 5 | code-review | bruce | MEDIUM |
