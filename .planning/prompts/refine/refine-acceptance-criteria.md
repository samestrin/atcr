...
## Inputs
You will be provided with the path to a plan directory (e.g., `.planning/plans/60.3_ui_test_blockers`) or a sprint directory with an embedded plan (e.g., `.planning/sprints/active/60.3_ui_test_blockers` → look in plan/).
