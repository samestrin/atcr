...
The shared review settings (`payload_mode`, `review_strategy`, `on_overflow`, `timeout_secs`, `payload_byte_budget`, `max_parallel`, `cache_max_bytes`, `fail_on`) resolve **per field, independently**, in this order:
