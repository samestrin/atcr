...
// It sits above reclib.ConfHigh in the v2 ordering (VERIFIED > HIGH > MEDIUM >
...
const ConfidenceVerified = reclib.ConfidenceVerified

// confidenceV2 maps a finding's v1 confidence and a skeptic verdict to its v2
// confidence tier (AC 03-01). It delegates to reclib.ConfidenceForVerdict, the
...
func confidenceV2(v1Confidence, verdict string) string {
	return reclib.ConfidenceForVerdict(v1Confidence, verdict)
}
