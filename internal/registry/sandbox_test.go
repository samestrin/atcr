...
func TestSandboxConfig_Validate(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid memory with two-char unit", &SandboxConfig{Image: "img", TestCommand: []string{"go", "test"}, Memory: "512mb"}, true, ""},
		...
		{"invalid memory exponent", &SandboxConfig{Image: "img", TestCommand: []string{"go", "test"}, Memory: "1e3"}, false, "is not a valid docker size"},
		{"invalid memory signed", &SandboxConfig{Image: "img", TestCommand: []string{"go", "test"}, Memory: "+512m"}, false, "is not a valid docker size"},
		{"invalid memory unknown unit", &SandboxConfig{Image: "img", TestCommand: []string{"go", "test"}, Memory: "512x"}, false, "is not a valid docker size"},
