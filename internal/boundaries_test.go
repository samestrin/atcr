...
var allowedInternalImports = map[string][]string{
	...
	"personas":       {"registry"}, // community persona lifecycle: validates fetched YAML via registry.ValidateAgentYAML; built-in roster from top-level personas/ (non-internal) (epic 9.0)
